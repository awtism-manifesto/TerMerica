...
namespace gunrightsmod.Content.Items
{
    ...
    {
        public static readonly int StupidAttackSpeedBonus = 14;
       
        public static readonly int AdditiveStupidDamageBonus = 14;
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            var line = new TooltipLine(Mod, "Face", "14% increased stupid damage and attack speed");
            tooltips.Add(line);
        ...
        public override void UpdateEquip(Player player)
        {
            ...
            player.GetDamage<StupidDamage>() += AdditiveStupidDamageBonus / 114f;
            player.GetAttackSpeed<StupidDamage>() += StupidAttackSpeedBonus / 114f;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient<Items.RockSaltChestplate>();
            recipe.AddIngredient<Items.PurifiedSalt>(81);

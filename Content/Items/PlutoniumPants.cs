...
namespace gunrightsmod.Content.Items
{
    ...
    public class PlutoniumPants : ModItem
    {
        ...
        public static readonly int AdditiveThrowDamageBonus = 8;
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            var line = new TooltipLine(Mod, "Face", "21% increased movement speed and 10% increased damage");
            tooltips.Add(line);
...

            {
                ...
                line = new TooltipLine(Mod, "Face", "8% increased throwing damage")
                {
                    OverrideColor = new Color(255, 255, 255)
                };
                tooltips.Add(line);
        ...
        public override void UpdateEquip(Player player)
        {
            ...
            player.GetDamage(DamageClass.Generic) += AdditiveDamageBonus / 110f;
...

            {
                ...
                player.GetDamage(DamageClass.Throwing) += AdditiveDamageBonus / 108f;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient<Items.PlutoniumBar>(31);

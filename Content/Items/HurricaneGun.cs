...
namespace gunrightsmod.Content.Items
{
    public class HurricaneGun : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shootSpeed = 12.25f; // The speed of the projectile (measured in pixels per frame.)
        ...
        public override void AddRecipes()
        {
            ...
            if (ModLoader.TryGetMod("MagnoliaMod", out Mod MagMerica) && MagMerica.TryFind("WindTome", out ModItem WindTome))


            {
                recipe.AddIngredient(WindTome.Type);

...
namespace gunrightsmod.Content.Items
{
    ...
    public class AstatineHelmet : ModItem
    {
        ...
        public static readonly int AdditiveDamageBonus = 22;
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            var line = new TooltipLine(Mod, "Face", "22% increased damage and 11% increased crit chance");
            tooltips.Add(line);
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient<Items.AstatineBar>(32);

...
namespace gunrightsmod.Content.Items
{
    ...
    public class PurifiedSaltLeggings : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            var line = new TooltipLine(Mod, "Face", "18% increased movement speed and stupid damage");
            tooltips.Add(line);
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient<Items.RockSaltLeggings>();
            recipe.AddIngredient<Items.PurifiedSalt>(72);

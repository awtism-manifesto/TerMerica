...
namespace gunrightsmod.Content.Items
{
    ...
    public class AstatineBreastplate : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            var line = new TooltipLine(Mod, "Face", "19% increased damage and 8% increased attack speed");
            tooltips.Add(line);
        ...
        public override void UpdateEquip(Player player)
        {
            ...
            player.GetDamage(DamageClass.Generic) += AdditiveDamageBonus / 119f;
        }
        // UpdateArmorSet allows you to give set bonuses to the armor.
        public override void AddRecipes()
        {
            Recipe recipe = CreateRecipe();
            recipe.AddIngredient<Items.AstatineBar>(48);

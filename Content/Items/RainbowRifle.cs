...
namespace gunrightsmod.Content.Items
{
    public class RainbowRifle : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.Register();
            if (ModLoader.TryGetMod("CalamityMod", out Mod CalMerica) && CalMerica.TryFind<ModItem>("CoreofEleum", out ModItem CoreofEleum))
            {
                recipe.AddIngredient(CoreofEleum.Type, 9);

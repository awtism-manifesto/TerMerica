...
namespace gunrightsmod.Content.Items
{
    ...
    public class PurifiedSaltFedora : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            var line = new TooltipLine(Mod, "Face", "19% increased stupid critical strike and +12 stupid armor penetration");
            tooltips.Add(line);
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient<Items.RockSaltFedora>();
            recipe.AddIngredient<Items.PurifiedSalt>(54);

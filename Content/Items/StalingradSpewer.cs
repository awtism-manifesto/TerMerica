...
namespace gunrightsmod.Content.Items
{
    public class StalingradSpewer : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            if (ModLoader.TryGetMod("MagnoliaMod", out Mod MagMerica) && MagMerica.TryFind<ModItem>("WallOfFleshIcon", out ModItem WallOfFleshIcon))
            {
                recipe = CreateRecipe();

                recipe.AddIngredient(WallOfFleshIcon.Type);

...
namespace gunrightsmod.Content.Items
{
    public class TrenboloneAcetate : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            var line = new TooltipLine(Mod, "Face", "7% incrased damage and attack speed for both the Stupid and Melee classes");
            tooltips.Add(line);
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.GetDamage(DamageClass.Melee) += AdditiveStupidDamageBonus / 107f;
            player.GetAttackSpeed(DamageClass.Melee) += MeleeAttackSpeedBonus / 107f;
            player.aggro += 400;
        }
    }
}
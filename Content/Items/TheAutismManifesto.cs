...
namespace gunrightsmod.Content.Items
{
    public class TheAutismManifesto : ModItem
    {
        ...
        public static readonly int AdditiveStupidDamageBonus = 20;

        public static readonly int MagicCritBonus = 15;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient<Items.SpiritProtectionCharm>();
            recipe.AddIngredient<Items.AutismDiagnosis>();
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            var line = new TooltipLine(Mod, "Face", "+75 mana, 15% increased magic+stupid crit chance and +20% stupid damage");
            tooltips.Add(line);

            line = new TooltipLine(Mod, "Face", "-Developer Item-")
            {
                OverrideColor = new Color(255, 111, 111)
            };
            tooltips.Add(line);
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.GetDamage<StupidDamage>() += AdditiveStupidDamageBonus / 120f;

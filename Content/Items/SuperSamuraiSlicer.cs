...
namespace gunrightsmod.Content.Items
{
    public class SuperSamuraiSlicer : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            if (ModLoader.TryGetMod("MagnoliaMod", out Mod MagMerica) && MagMerica.TryFind<ModItem>("KingSlimeIcon", out ModItem KingSlimeIcon))
            {
                recipe = CreateRecipe();
               
                recipe.AddIngredient(KingSlimeIcon.Type);

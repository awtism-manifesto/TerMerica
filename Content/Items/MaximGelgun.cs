...
namespace gunrightsmod.Content.Items
{
    public class MaximGelgun : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            if (ModLoader.TryGetMod("MagnoliaMod", out Mod MagMerica) && MagMerica.TryFind<ModItem>("QueenSlimeIcon", out ModItem QueenSlimeIcon))
            {
                recipe = CreateRecipe();

                recipe.AddIngredient(QueenSlimeIcon.Type);

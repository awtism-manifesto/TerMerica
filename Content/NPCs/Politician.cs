...
namespace gunrightsmod.Content.NPCs
{
    ...
    public class Politician : ModNPC
    {
        ...
        public override string GetChat()
        {
            ...
            chat.Add(Language.GetTextValue("I sold my soul to the state of Israel for this???"), 0.66);
            ...
            chat.Add(Language.GetTextValue("There are kids freezing in tents in North Carolina and Los Angeles is on fucking fire but i think banning TikTok is more important. Why? because you're an idiot, that's why!"), 0.2);

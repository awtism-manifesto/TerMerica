...
using gunrightsmod.Content.GlobalNPCs;
    ...
    public class River : ModNPC
    {
        ...
        public override string GetChat()
        {
            ...
            if (NPC.IsShimmerVariant)
            {
                ...
                chat.Add(Language.GetTextValue("Despite what my nametag tells you, my name is Pond. I just had to borrow River's for while I was here."), 5);
            ...
            if (Main.raining)
            {
                ...
                chat.Add(Language.GetTextValue("ou ever stick your head out of a window and let the wind blow in your face like a dog? N-no..? Heh, yeah, me neither..."));
        ...
        public override void AddShops()
        {
            var npcShop = new NPCShop(Type, ShopName)
             ...
             .Add(ItemID.Extractinator)
                   ...
                   .Add<GoldMultiaxe>(condition: Terraria.Condition.PlayerCarriesItem(ModContent.ItemType<PlatinumMultiaxe>()))
                    .Add<PlatinumMultiaxe>(condition: Terraria.Condition.PlayerCarriesItem(ModContent.ItemType<GoldMultiaxe>()))
            ...
            if (ModLoader.TryGetMod("MagnoliaMod", out Mod MagMerica) && MagMerica.TryFind<ModItem>("BloatItem", out ModItem BloatItem) 
                && MagMerica.TryFind<ModItem>("PrideFlag", out ModItem PrideFlag))
            {
              npcShop.Add(PrideFlag.Type);
                npcShop.Add(BloatItem.Type);
        ...
        {
            projType = ModContent.ProjectileType<PearlProj>();
            attackDelay = 1;
        }

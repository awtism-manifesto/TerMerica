...
namespace gunrightsmod.Content.Projectiles
{
    public class TedPackage : ModProjectile
    {
        ...
        {
            target.AddBuff(BuffID.Venom, 333);
            target.AddBuff(BuffID.Oiled, 333);
            target.AddBuff(BuffID.Frostburn, 333);
            target.AddBuff(BuffID.Frostburn2, 333);
            target.AddBuff(BuffID.CursedInferno, 333);
            target.AddBuff(BuffID.Ichor, 333);
            target.AddBuff(BuffID.Poisoned, 333);
            target.AddBuff(BuffID.Slimed, 333);
            target.AddBuff(BuffID.ShadowFlame, 333);
            target.AddBuff(BuffID.OnFire3, 333);
            target.AddBuff(BuffID.OnFire, 333);
            target.AddBuff(BuffID.TentacleSpike, 333);

    ...
    public class ParticleBeam : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int j = 0; j < 10; j++)
            {
                ...
                Dust RubyDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.GemRuby, 0f, 0f, 100, default, 1f);
                RubyDust.noGravity = true;
                RubyDust.velocity *= 7f;
                RubyDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.GemRuby, 0f, 0f, 100, default, 1f);

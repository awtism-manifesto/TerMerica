        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (Main.rand.NextBool(2))
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits, velocity,
                    ModContent.ProjectileType<LycoSpore>(), (int)(Projectile.damage * 0.5f), Projectile.knockBack, Projectile.owner);
            }
            ...
            if (Main.rand.NextBool(4))
            {
                ...
                ModContent.ProjectileType<BoomShroomMage>(), (int)(Projectile.damage * 1.1f), Projectile.knockBack, Projectile.owner);
            }

...
namespace gunrightsmod.Content.Projectiles
{
    ...
    public class BlackshardProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float scaleMulti = 0.66f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
            float scaleAdder = 0.7f; // Excalibur, Terra Blade, and The Horseman's Blade is 1f; True Excalibur is 1.2f; default is 1f 
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
        {
            ...
            float coneLength = 48f * Projectile.scale;
            ...
            if (target.HasBuff(ModContent.BuffType<BlackshardDebuff>()))
            {
               ...
               Projectile.owner);
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits, velocity,
                    ModContent.ProjectileType<KnightSwordCombo>(), (int)(Projectile.damage * 0.5f), Projectile.knockBack, Projectile.owner);
